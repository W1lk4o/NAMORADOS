...
const STORY = [
  ...
  {
    type: "text",
    chapter: "Nossa história",
    headline: "Tudo começou\nem <em>2016</em>",
    body: "Dois caminhos que Deus conduziu até o mesmo lugar. O que parecia acaso era, na verdade, um plano.",
    verse: null,
    duration: 6000,
  },
  // 1 — Virada 2016/2017
  {
    ...
    body: "Deus uniu dois corações numa noite que ficaria para sempre na memória.",
    duration: 7000,
  },
  // 2 — 08/05/2017
  {
    ...
    body: "Cada sorriso, cada momento juntos — marcado pela graça de Deus sobre a vida do casal.",
  ...
  // 3 — Chá revelação
  {
    ...
    body: "Uma menina estava a caminho. Bernardo já fazia parte da família, e juntos esperavam Helena com o coração cheio de alegria.",
    duration: 7000,
  },
  // 4 — Natal 2018
  {
    ...
    body: "A melhor expectativa de Natal: o presente que já crescia dentro do ventre de Ana Aressa.",
  ...
  // 5 — Nascimento Helena
  {
    ...
    headline: "Helena\n<em>chegou</em>",
    body: "No dia 12 de fevereiro de 2019, Deus presenteou a família com Helena. O choro dela foi a mais bela música que os dois já ouviram.",
    duration: 7500,
  },
  // 6 — Newborn Helena
  {
    ...
    headline: "Três\n<em>corações</em>",
    body: "O ensaio que eternizou o olhar dos pais sobre a filha. Silêncio, gratidão e amor que transborda.",
    verse: ""Deus cuida de cada detalhe da sua história."",
    duration: 7000,
  },
  // 7 — Viagem praia
  {
    ...
    body: "Ainda sem saber o que 2020 traria, o casal aproveitava cada instante de alegria. Deus os preparava para o que viria.",
    duration: 7000,
  },
  // 8 — Texto pandemia
  {
    ...
    headline: "O mundo\n<em>parou</em>",
    body: "2020. O mundo fechou as portas. Mas dentro de casa, Deus abriu janelas. A pandemia testou, moldou e fortaleceu o casamento de Ana e Wilker.",
  ...
  // 9 — Pandemia fotos
  {
    ...
    headline: "Juntos em\n<em>tudo</em>",
    body: "Entre as dificuldades, o amor resistiu. Deus estava presente em cada dia difícil, em cada conversa, em cada abraço.",
    duration: 7000,
  },
  {
    type: "photo",
    ...
    body: "Depois de tudo que passaram juntos, o sorriso continuou. Essa é a prova de que Deus estava cuidando.",
    verse: ""Deus fortaleceu nosso casamento."",
    duration: 7000,
  },
  // 10 — Casamento texto
  {
    ...
    body: "No meio da pandemia, Ana e Wilker disseram sim diante de Deus. Nenhuma circunstância foi capaz de adiar o que Ele já tinha escrito.",
    verse: ""O que Deus uniu, o homem não separe" — Mateus 19:6",
    duration: 7000,
  },
  // 11 — Oliver nascimento
  {
    type: "photo",
    photo: "photo10",
    ...
    headline: "Oliver\n<em>Ingrácio</em>",
    body: "Em 28 de abril de 2025, Oliver chegou. Mais uma vez, Deus disse: 'Eu nunca deixei de cuidar de vocês.'",
  ...
  // 12 — Família completa
  {
    ...
    headline: "A família que\n<em>Deus nos deu</em>",
    body: "Ana Aressa. Wilker. Bernardo. Helena. Oliver. Cinco vidas, uma história, um Deus. Tudo isso é graça.",
    duration: 8000,
  },
  // 13 — Virada 2025/2026
  {
    ...
    headline: "Hoje e\n<em>sempre</em>",
    body: "Com o futuro à frente e Deus no centro, o casal entrou em 2026 de mãos dadas. A história continua — e o melhor ainda está por vir.",
    verse: ""Porque eu sei os planos que tenho para vocês, planos de paz e não de mal" — Jeremias 29:11",
    duration: 8000,
  },
  // 14 — Carta final
  {
  ...
  if (data.type === "letter") {
    ...
    el.innerHTML = `
      <div class="slide-text">
        ...
        <h2 class="slide-headline">${formatHeadline(data.headline)}</h2>
...
pauseBtn.addEventListener("click", () => {
  ...
  if (paused) {
    ...
    scheduleNext(Math.max(timerRemaining, 1000));
  }
});
...
function startHearts() {
  ...
  for (let i = 0; i < 40; i++) {
    hearts.push({
      ...
      color: Math.random() > 0.5 ? "#C9A84C" : "#E8D08A",
    });
  }
  ...
  function drawHeart(ctx, x, y, size, alpha, color) {
    ...
    ctx.bezierCurveTo(x - size * 0.5, y - size * 1.1, x, y - size * 1.1, x, y - size * 0.7);
    ctx.bezierCurveTo(x, y - size * 1.1, x + size * 0.5, y - size * 1.1, x + size * 0.5, y - size * 0.5);
...
// ─── QR Code (inline generator) ──────────
function drawQR() {
  const url = window.location.href.split("?")[0];
  document.getElementById("qrUrl").textContent = url;

  // Simple QR-like visual placeholder using canvas
  // For a real QR, include qrcode.js library
  ...
  // Generate QR using available library if loaded, else show URL text
  if (typeof QRCode !== "undefined") {
    ...
    new QRCode(div, {
      ...
      colorDark: "#1A1208", colorLight: "#F7F2E8",
    });
  } else {
    ...
    ctx.fillText("Escaneie para", size/2, size/2 - 8);
    ctx.fillText("compartilhar", size/2, size/2 + 8);
